        ...
        <Container fluid="true" id="footer">
            <div className="d-flex justify-content-center">
                <a className="social" href="https://www.facebook.com/theietcet/">
                    <svg width="2em" height="2em" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <a className="social" href="https://instagram.com/ietcet?igshid=1nfxkw5gz2va2">
                    <svg width="2em" height="2em" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" class="svg-inline--fa fa-instagram fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
